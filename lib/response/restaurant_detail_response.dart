...
class RestaurantDetailResponse {
  ...
  factory RestaurantDetailResponse.fromJson(Map<String, dynamic> json) => RestaurantDetailResponse(
    ...
    restaurant: RestaurantsDetail.fromJson(json["restaurant"]),
  );
...
class RestaurantsDetail {
  ...
  factory RestaurantsDetail.fromRawJson(String str) => RestaurantsDetail.fromJson(json.decode(str));
